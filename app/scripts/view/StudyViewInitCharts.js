...
var StudyViewInitCharts = (function(){
    ...
    function initData(dataObtained) {
        ...
        if(studyPrioritiseAttrs.hasOwnProperty(StudyViewParams.params.studyId)) {
            _highPriorityAttrs = studyPrioritiseAttrs[StudyViewParams.params.studyId].high.concat(_highPriorityAttrs);
            _lowPriorityAttrs = studyPrioritiseAttrs[StudyViewParams.params.studyId].low.concat(_lowPriorityAttrs);
        }
