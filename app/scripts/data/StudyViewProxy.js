...
var StudyViewProxy = (function () {
  ...
  function initLocalParameters(callBack) {
    ...
    $.ajax({
      url: "data/" + dataFolder + "/webservice.json",
      data: {
  ...
  function getDataFunc(callbackFunc) {
    $.when(
      $.ajax({url: "data/" + dataFolder + "/webserviceMain.json"}),
      $.ajax({url: "data/" + dataFolder + "/mutation.json"}),
      $.ajax({url: "data/" + dataFolder + "/cna.json"}),
      $.ajax({url: "data/" + dataFolder + "/Gistic.json"}),
      $.ajax({url: "data/" + dataFolder + "/webserviceStudy"})
...
//        }
  ...
  function getCNAData() {
    ...
    if (obtainDataObject.hasOwnProperty('cna') && obtainDataObject.cna) {
      ...
      if (hasCNA) {
        $.ajax({url: "data/" + dataFolder + "/cna2.json"})
          .then(function (data) {
  ...
  function getMutatedGenesData() {
    ...
    if (obtainDataObject.hasOwnProperty('mutatedGenes') && obtainDataObject.mutatedGenes) {
      ...
      if (hasMutation) {
        $.ajax({url: "data/" + dataFolder + "/mutationMain.json"})
          .then(function (data) {
  ...
  return {
    ...
    getGisticData: function () {
      return obtainDataObject.gistic;
    },
    getCNAData: getCNAData,
    getSampleidToPatientidMap: function () {
      return obtainDataObject.sampleidToPatientidMap;
    },
